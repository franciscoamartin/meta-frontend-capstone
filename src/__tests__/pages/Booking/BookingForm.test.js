...
import BookingForm from '../../../pages/Bookings/Booking/BookingForm';
...
describe('Booking form', () => {
  ...
  it('should correctly render all fields and their default values', async () => {
    render(
  ...
  it('should successfully submit form with default values', () => {
    render(
      <BookingForm availableTimes={availableTimes} submitData={submitData} />
    );
